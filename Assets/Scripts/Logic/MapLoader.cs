...
public sealed class MapLoader : MonoBehaviour
{
    ...
    public void Start()
    {
        LoadMap(@"C:\Users\Remec\BSManager\BSInstances\1.39.1 (1)\Beat Saber_Data\CustomLevels\3ffc7 (Castle Vein + Hall of Sacreligious Remains - Remec)\ExpertPlusStandard.dat");
    }
...
{
    private string _path = @"C:\Users\Remec\BSManager\BSInstances\1.39.1 (1)\Beat Saber_Data\CustomLevels\3ffc7 (Castle Vein + Hall of Sacreligious Remains - Remec)\ExpertPlusStandard.dat"; // temporary hardcode
