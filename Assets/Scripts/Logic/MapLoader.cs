...
public sealed class MapLoader : MonoBehaviour
{
    ...
    public void Start()
    {
        LoadMap(@"C:\Users\Remec\Downloads\24aea (Dimension - Water)\ExpertPlusStandard.dat");
    }
...
{
    private string _path = @"C:\Users\Remec\Downloads\24aea (Dimension - Water)\ExpertPlusStandard.dat"; // temporary hardcode
